...
train_fea = get_length_dataframe()
train_fea = train_fea.join(get_date_dataframe(train["saledate"]))

test_fea = get_date_dataframe(test["saledate"])
test_fea = test_fea.join(get_length_dataframe())
